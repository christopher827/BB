...
function App() {
  return (
    <div className=" bg-[#fffcf4] overflow-hidden">
      <Routes>
        ...
        <Route
          path="/competitionsandawards"
          element={<CompetitionandAwards />}
        />
        <Route
          path="/diyschoolbeautification"
          element={<DIYSchoolBeautification />}
        />
