...
<AnimatedText text={"Benefits of Joining Project Blue Bins"} className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center text-blue font-bold leading-7 md:leading-10'/>
