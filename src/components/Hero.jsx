...
function Hero() {
  return (
    <div className=" relative">
      <div className=" z-[50] ">
        <div className="  px-6 lg:px-36 sm:mb-6 lg:pt-[8rem] pt-[7rem] z-[50] ">
          ...
          <motion.p className="sm:text-base text-gray-800 text-[12px] mb-2">
            and afford your school access to quality recycling education for the
            next generation of Lagosians.
          </motion.p>
        </div>
